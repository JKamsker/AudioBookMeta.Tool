...
- [Development and architecture](development.md) covers the .NET solution, source layout, tests, provider architecture, and Kiota client generation.
- [Initial specification](tasks/initial/bookmeta-cli-spec/README.md) contains the normative v1 requirements, provider research, schemas, fixtures, and acceptance plan.
